...
function Alert({ id, fade }) {
    ...
    function cssClasses(alert) {
        ...
        const alertTypeClass = {
            [AlertType.Success]: 'text-white px-6 py-4 border-0 rounded relative mb-4 bg-green-500',
            [AlertType.Error]: 'text-white px-6 py-4 border-0 rounded relative mb-4 bg-red-500',
            [AlertType.Info]: 'text-white px-6 py-4 border-0 rounded relative mb-4 bg-slate-500',
            [AlertType.Warning]: 'text-white px-6 py-4 border-0 rounded relative mb-4 bg-amber-500'
        }
