...
import Dio from '../public/Dio_Logo_Select.jpg';
            ...
            <Nav className="mr-auto" navbar data-testid="navbar-items">
              <NavItem>
                <PageLink href="/" className="nav-link" testId="navbar-home">
                  <Image className='w-150 h-150 ' src={Dio}
                   width='70' height='70' />
                </PageLink>
              </NavItem>
              {user && (
                <>
                  <NavItem>
                    <PageLink href="/explore" className="nav-link" testId="navbar-csr">
                      Мэргэжил харьцуулах
                    </PageLink>
                  </NavItem>
                  <NavItem>
                    <PageLink href="/explore" className="nav-link" testId="navbar-ssr">
                      Их сургууль харьцуулах
                    </PageLink>
                  </NavItem>
                  <NavItem>
